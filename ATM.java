...
public class ATM{
    public static void main(String[]args){
        ...
        User aUser = theBank.addUser("Harshvardhan","Shandilya","1111");
    ...
    public static void transferFunds(User theUser,Scanner sc){
        ...
        do{
            System.out.println("Enter the amount to transfer (max than Rs"+actBal+") : Rs");
            amount = sc.nextDouble();
            if(amount < 0){
                System.out.println("Amount must be greater than zero");
            }else if(amount > actBal){
                System.out.println("Amount must not be greater than \n"+"balance of Rs"+actBal);
            }
    ...
    public static void withdrawFunds(User theUser,Scanner sc){
        ...
        //get the amount to traansfer
        do{
            System.out.println("Enter the amount to withdraw (max Rs "+actBal+"): Rs");
            amount = sc.nextDouble();
            if(amount < 0){
                System.out.println("Amount must be greater than zero");
            }else if(amount > actBal){
    ...
    public static void depositeFunds(User theUser,Scanner sc){
        ...
        do{
            System.out.print("Enter the amount to deposite (max than Rs"+actBal+") :Rs");
            amount = sc.nextDouble();
            if(amount < 0){
                System.out.println("Amount must be greater than zero");
            }
